...
# Как угодно создайте третий массив так, чтобы он состоял из всех элементов первого и второго массивов (т. е. из всех мужских и женских имен), 
# не повторяя эти имена в коде. То есть, используя элементы из первых двух массивов.

# Потом выведите все три массива на экран.

# Объявите в программе массив из моделей мобильных телефонов (всего около 10). Выведите на экран размер этого массива (но не сам массив) 
